...
Nachdem die Silbentrennung aktiviert ist müssen wir müssen noch individuelle Einstellungen, die sich je nach Layout richten sollten, vorgenommen werden. 

### Einstellungen für Silbentrennung
- Unter `Absatz` → (Aufklappmenü) ![](bilder/mehr-button.png) → Silbentrennung 
